...
{
	[Table("PunchPairs", Schema = "UtahEmployee")]
	public class PunchPair
	{
		...
		public bool? IsFirstInPunch { get; set; }
		public bool? HasPotentialError { get; set; }
		public bool? IsOddPunch { get; set; }
		public int? DayPunchNum { get; set; }
		public DateTime? NextStamp { get; set; }
		public int? TotalMinutesDifference { get; set; }
